...
savefig("content/post/CellPotts ODEs/cellCount.png") 
...
savefig("content/post/CellPotts ODEs/ProteinX.png") 
...
gif(anim, "content/post/CellPotts ODEs/BringingODEsToLife.gif", fps = 30) 